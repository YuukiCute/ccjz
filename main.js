...
/*lobal.thanhdz = new Object({
  altp_url: "https://bngssvcas.oiqoweiusncxc.repl.co/altp_data"
})*/
...
const config = {
  ...
  if(username !== undefined) {
    ...
    logger('Bạn đang chạy ở link: ' + urlRepl, '[ CHECK HOST ]');
  ...
  async function connectUptime(url, name) {
    try {
      const res = (await axios.get(`https://baodapchai.quangbao04.repl.co/uptimerobot/create?url=${url}`)).data;
...
try {
    ...
    global.configApi = global.config.configApi;
...
/*function checkBan(checkban) {
    ...
    return axios.get('https://raw.githubusercontent.com/kenyrm2250/GbanMirai/mainV2/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/baodapchai/GbanMirai/mainV2/data.json').then(json => {
...
chalkAnimation.rainbow('\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n\n███╗░░░███╗██╗██████╗░░█████╗░██╗\n████╗░████║██║██╔══██╗██╔══██╗██║\n██╔████╔██║██║██████╔╝███████║██║\n██║╚██╔╝██║██║██╔══██╗██╔══██║██║\n██║░╚═╝░██║██║██║░░██║██║░░██║██║\n╚═╝░░░░░╚═╝╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝\n\n\n➣ Thông Tin Bot\n➣ Mirai V2 - Version 1.2.14 🌸\n➣ Bot Mod By • Quang Bảo 🐧\n➣ Zalo • https://zalo.me/g/bwzoem854 💌\n➣ Facebook • http://facebook.com/quangbao04\n➣ Gmail • nguyencongquangbao@gmail.com 🧸\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
