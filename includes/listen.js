...
(async function () {
    ...
    try {
      ...
      for (const dataU of users) {
    	...
    	logger.loader(`BOT QUANG BẢO BẮT ĐẦU NHẬN LỆNH`);
    } catch (error) {
...
𑁍 𝐍𝐠𝐮𝐲𝐞̂̃𝐧 𝐌𝐚̣𝐧𝐡 𝐓𝐨𝐚̀𝐧 𖤐 Đ𝐞̣𝐩 𝐓𝐫𝐚𝐢 𝐒𝐨̂́ 𝐌𝐨̣̂𝐭 𝐓𝐡𝐚́𝐢 𝐁𝐢̀𝐧𝐡 
...
`, "Toàn");
  logger(`${global.config.ADMINBOT} - Toàn is main!!!`, "ADMINBOT INFO");
  logger(`${global.config.NDH}`, "NDH INFO");
  logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] ➜ ${(!global.config.BOTNAME) ? "This bot was made by Toàn" : global.config.BOTNAME}`, "BOT INFORMATION");*/
