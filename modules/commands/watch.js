...
module.exports.handleReply = async function ({
    ...
    try {
        ...
        if (fs.statSync(__dirname + `/cache/${event.senderID}.mp4`).size > 104000000) return api.sendMessage('[⚜️]➜ 𝐊𝐡𝐨̂𝐧𝐠 𝐭𝐡𝐞̂̉ 𝐠𝐮̛̉𝐢 𝐯𝐢𝐝𝐞𝐨 𝐯𝐢̀ 𝐝𝐮𝐧𝐠 𝐥𝐮̛𝐨̛̣𝐧𝐠 𝐥𝐨̛́𝐧 𝐡𝐨̛𝐧 𝟐𝟓𝐦𝐛', event.threadID, () => unlinkSync(__dirname + `/cache/${event.senderID}.mp4`), event.messageID);
        ...
        return api.sendMessage('[⚜️]➜ 𝐊𝐡𝐨̂𝐧𝐠 𝐭𝐡𝐞̂̉ 𝐱𝐮̛̉ 𝐥𝐲́ 𝐲𝐞̂𝐮 𝐜𝐚̂̀𝐮 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧', event.threadID, event.messageID);
    }
...
module.exports.run = async function ({
    ...
    if (args.length == 0 || !args) return api.sendMessage('[⚜️]➜ 𝐏𝐡𝐚̂̀𝐧 𝐭𝐢̀𝐦 𝐤𝐢𝐞̂́𝐦 𝐤𝐡𝐨̂𝐧𝐠 𝐭𝐡𝐞̂̉ 𝐛𝐨̉ 𝐭𝐫𝐨̂́𝐧𝐠', event.threadID, event.messageID);
    ...
    if (args.join(" ").indexOf("https://") == 0) {
        ...
        try {
            ...
            var body = `[🔎]➜ 𝐂𝐨́ ${link.length} 𝐝𝐚𝐧𝐡 𝐬𝐚́𝐜𝐡 𝐭𝐫𝐮̀𝐧𝐠 𝐯𝐨̛́𝐢 𝐭𝐮̛̀ 𝐤𝐡𝐨𝐚́ 𝐭𝐢̀𝐦 𝐤𝐢𝐞̂́𝐦 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧:\n\n${msg}\n[⚜️]➜ 𝐇𝐚̃𝐲 𝐫𝐞𝐩𝐥𝐲 (𝐩𝐡𝐚̉𝐧 𝐡𝐨̂̀𝐢 𝐭𝐡𝐞𝐨 𝐬𝐨̂́ 𝐭𝐡𝐮̛́ 𝐭𝐮̛̣) 𝐜𝐡𝐨̣𝐧 𝐦𝐨̣̂𝐭 𝐭𝐫𝐨𝐧𝐠 𝐧𝐡𝐮̛̃𝐧𝐠 𝐭𝐢̀𝐦 𝐤𝐢𝐞̂́𝐦 𝐭𝐫𝐞̂𝐧`
            return api.sendMessage({
                    attachment: imgthumnail,
                    body: body
                }, event.threadID, (error, info) => global.client.handleReply.push({
