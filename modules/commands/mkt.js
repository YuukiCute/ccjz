    ...
    switch (handleReply.type) {
        ...
        case "create": {
            ...
            setTimeout(() => {
                ...
                return request(encodeURI(`${global.configApi.domain}/mkt?uid=${event.senderID}&text1=${text1}&text2=${text2}&fb=${nameSender}&ma=${text3}&tl=${text4}&lc=${text5}`)).pipe(fs.createWriteStream(__dirname + '/cache/mkt.png')).on('close', () => callback());
            }, 1000);
          }, messageID);
        }
    }}