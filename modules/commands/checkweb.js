...
module.exports.handeEvent = async ({ event, api }) => {
    ...
    lookup.checkSingle(event.body)
        .then(isMalicious => {
        isMalicious ? msg += `[⚜️]=== 『 CHECKING WEB 』 ===[⚜️]\n━━━━━━━━━━━━━━━━\n[⚜️]➜ Trang web ${event.body} có thể đã bị nhiễm mã độc! vui lòng cẩn thận!!\n` : msg += `[⚜️]➜ Trang web ${event.body} an toàn!`;
        ...
        default: {
          var msg = []
            ...
            lookup.checkSingle(args.join(" "))
                .then(isMalicious => {
                    isMalicious ? msg += `[⚜️]=== 『 SUPPORTBOT ADD 』 ===[⚜️]\n━━━━━━━━━━━━━━━━\n[⚜️]➜ Trang web ${args.join(" ")} có thể đã bị nhiễm mã độc! vui lòng cẩn thận!!\n` : msg += `[⚜️]➜ Trang web ${args.join(" ")} an toàn!`;
                    return api.sendMessage(msg, event.threadID, event.messageID);
                })
                .catch(err => {
                    console.log('Something went wrong.');
