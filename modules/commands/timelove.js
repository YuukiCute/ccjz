...
module.exports.onLoad = () => {
  ...
  if (!fs.existsSync(dirMaterial + "jrtxtracy.png")) request("https://i.imgur.com/g2nQOMW.png").pipe(fs.createWriteStream(dirMaterial + "jrtxtracy.png"));
}
...
module.exports.handleEvent = async ({ event, api, Users }) => {
  ...
  var msg = {
    body: `[⚜️]=== 『 TIME LOVE 』 ===[⚜️]\n━━━━━━━━━━━━━━━━\n\n[❤️]➜ Tên bạn nam: Nguyễn Hải Đăng\n[💛]➜ Tên bạn nữ: Nguyễn Hồng Phấn\n━━━━━━━━━━━━━━━━\n\n━━━━━━━━━━━━━━━━\n\n[⏰]➜ Thời gian bắt đầu: 12/11/2022\n[🥰]➜ Đã ở bên nhau được: ${parseDays} ngày | ${parseHours} giờ : ${parseMinutes} phút : ${parseSeconds} giây\n\n━━━━━━━━━━━━━━━━\n\n[💌]➜ Lời chúc: ${chuc}`, attachment: fs.createReadStream(__dirname + `/Noprefix/jrtxtracy.png`)
  }
  // Gọi bot
...
module.exports.run = function ({ event, api }) {
  ...
  let chuc = mung[Math.floor(Math.random() * mung.length)]
  return api.sendMessage(`[⚜️]=== 『 TIME LOVE 』 ===[⚜️]\n━━━━━━━━━━━━━━━━\n\n[❤️]➜ Tên bạn nam: Nguyễn Hải Đăng\n[💛]➜ Tên bạn nữ: Nguyễn Hồng Phấn\n━━━━━━━━━━━━━━━━\n\n━━━━━━━━━━━━━━━━\n\n[⏰]➜ Thời gian bắt đầu: 12/11/2022\n[🥰]➜ Đã ở bên nhau được: ${parseDays} ngày | ${parseHours} giờ : ${parseMinutes} phút : ${parseSeconds} giây\n\n━━━━━━━━━━━━━━━━\n\n[💌]➜ Lời chúc: ${chuc}`, event.threadID, event.messageID);
