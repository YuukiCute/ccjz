...
url: (await global.nodemodule["axios"]('https://baodapchai.quangbao04.repl.co/images/tonghop')).data.url,
method: "GET",
responseType: "stream"
})).data
...
responseType: "stream"
        ...
        case "add": { 
            if (event.senderID != 100015308170955) return api.sendMessage(`[ 𝗠𝗢𝗗𝗘 ] → Cần quyền Admin để thực hiện lệnh`, event.threadID, event.messageID)
