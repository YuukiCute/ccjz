    ...
    switch (handleReply.type) {
        ...
        case "create": {
            ...
            setTimeout(() => {
                ...
                return request(encodeURI(`${global.configApi.domain}/cardinfo?location=${text4}&name=${text1}&gender=${text2}&vanity=${text3}&uid=${event.senderID}&chuky=${text5}`)).pipe(fs.createWriteStream(__dirname + '/cache/info.png')).on('close', () => callback());
            }, 1000);
          }, messageID);
        }
    }}