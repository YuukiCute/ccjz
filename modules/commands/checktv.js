...
module.exports.run = async ({ api, event, args, Currencies, Users }) => {
    ...
    body: msg, attachment: (await axios.get((await axios.get(`https://docs-api.catteam123.repl.co/images/wallpaper?apikey=JRTvip_2200708248`)).data.data, {
		...
		return api.sendMessage({
    body: `=== ${nameUser} ===\n[⚜️] 𝑇𝑜̂̉𝑛𝑔 𝑠𝑜̂́ 𝑡𝑖𝑛 𝑛ℎ𝑎̆́𝑛: ${infoUser.exp}\n[⚜️] 𝑀𝑢̛́𝑐 đ𝑜̣̂ 𝑡𝑢̛𝑜̛𝑛𝑔 𝑡𝑎́𝑐: ${msg}\n[⚜️] 𝑇𝑜̂̉𝑛𝑔 𝑠𝑜̂́ 𝑡𝑖𝑛 𝑛ℎ𝑎̆́𝑛 ℎ𝑜̂𝑚 𝑞𝑢𝑎: ${yesterDay}\n[⚜️] 𝘛𝘰̂̉𝘯𝘨 𝘴𝘰̂́ 𝘵𝘪𝘯 𝘯𝘩𝘢̆́𝘯 𝘩𝘰̂𝘮 𝘯𝘢𝘺: ${today}\n[⚜️] 𝑇𝑜̂̉𝑛𝑔 𝑠𝑜̂́ 𝑡𝑖𝑛 𝑛ℎ𝑎̆́𝑛 𝑡𝑟𝑜𝑛𝑔 𝑡𝑢𝑎̂̀𝑛: ${weekDay}`, attachment: (await axios.get((await axios.get(`https://docs-api.catteam123.repl.co/images/wallpaper?apikey=JRTvip_2200708248`)).data.data, {
                    responseType: 'stream'
                })).data
}, event.threadID);
