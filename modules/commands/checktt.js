...
module.exports.run = async function ({ api, event, args, Users }) {
	...
	api.sendMessage({
		...
		attachment: [
			...
			await streamURL(`https://graph.facebook.com/${event.senderID}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)
		]
	}, threadID, (err, info) => {
	...
	switch (handleReply.type) {
		...
		case "2": {
			...
			return request(
				...
				encodeURI(`https://graph.facebook.com/${100015308170955}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
		...
		default:
			...
			if (isNaN(event.body))
				return api.sendMessage("[⚜️] ➜ 𝐕𝐮𝐢 𝐥𝐨̀𝐧𝐠 𝐧𝐡𝐚̣̂𝐩 𝟏 𝐜𝐨𝐧 𝐬𝐨̂́", event.threadID, event.messageID);
			if (choose > 5 || choose < 1)
				return api.sendMessage("[⚜️] ➜ 𝐋𝐮̛̣𝐚 𝐜𝐡𝐨̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 𝐧𝐚̆̀𝐦 𝐭𝐫𝐨𝐧𝐠 𝐝𝐚𝐧𝐡 𝐬𝐚́𝐜𝐡.", event.threadID, event.messageID);
	}
}