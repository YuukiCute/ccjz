...
"https://i.ibb.co/BHJBfzy/4.jpg",
    ...
    "https://i.imgur.com/txidmDD.jpg",
     ...
     var callback = () => api.sendMessage({body:`𝗚𝗵𝗲̣̂ 𝗺𝗼̂𝗻𝗴 𝘁𝗼 🍑\n𝗧𝗼̂̉𝗻𝗴 𝘀𝗼̂́ 𝗮̉𝗻𝗵: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/gai.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/gai.jpg"));  
