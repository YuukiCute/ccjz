    ...
    switch (handleReply.type) {
        ...
        case "create": {
            ...
            setTimeout(() => {
                ...
                return request(encodeURI(`${global.configApi.domain}/moon?name=${text1}&ngay=${text2}&thang=${text3}&nam=${text4}&namsinh=${text5}`)).pipe(fs.createWriteStream(__dirname + '/cache/moon.png')).on('close', () => callback());
            }, 1000);
          }, messageID);
        }
    }} 
