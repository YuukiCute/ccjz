...
module.exports.uptime = async() =>{
    ...
    const randomAnime = (await axios.get('https://docs-api.catteam123.repl.co/taoanhdep/random')).data;
    ...
    var ctx = canvas.getContext("2d");
        ...
        ctx.fillStyle = "#fff";
        ctx.textAlign = "start";
        ctx.fillText('Nguyễn Hải Đăng', 274, 453);
