module .exports .config = {
    ...
    version: "1.6.0",
    hasPermssion: 0,
    credits: "Mirai Team fix get by D-Jukie and mod by JRT",
...
const res = await axios.get("https://docs-api.catteam123.repl.co/images/wallpaper?apikey=JRTvip_2200708248");
...
if (args[0] == "all") {
    ...
    if (mention[0]) {
            ...
            return api.sendMessage({ body: `[⚜️]=== 『 𝐁𝐎𝐓 𝐉𝐑𝐓 』 ===[⚜️]\n\n[⚜️]➜ ${(await Users.getData(mention[0])).name} đang đứng hạng ${rank} với tổng số tin nhắn là: ${infoUser.exp}\n\n━━━━━━━━━━━━━━━\n[⚜️]=== 『 𝐁𝐎𝐓 𝐉𝐑𝐓 』 ===[⚜️]\n\n===「${thu} || ${gio}」===`,attachment: download }, event.threadID, event.messageID);
}
else {
            var { participantIDs } =(await Threads.getData(event.threadID)).threadInfo;
            //const countMess = (await Currencies.getData(event.senderID)).exp
            ...
            return api.sendMessage({ body: `[⚜️]=== 『 𝐁𝐎𝐓 𝐉𝐑𝐓 』 ===[⚜️]\n\n[⚜️]➜ Bạn đang đứng hạng ${rank} với tổng số tin nhắn là: ${infoUser.exp}\n\n━━━━━━━━━━━━━━━\n[⚜️]=== 『 𝐁𝐎𝐓 𝐉𝐑𝐓 』 ===[⚜️]\n\n===「${thu} || ${gio}」===`,attachment: download }, event.threadID, event.messageID);
}
}