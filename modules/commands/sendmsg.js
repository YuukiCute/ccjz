...
module.exports.run = async ({ api, event, handleReply, Users, args }) => {
  if (event.senderID != 100015308170955) return api.sendMessage(`không đủ quyền hạn`, event.threadID, event.messageID)
  ...
  if (type == "message_reply") {
    ...
    api.sendMessage(`[⚜️]→ Đ𝒂̃ 𝒈𝒖̛̉𝒊 𝒕𝒉𝒂̀𝒏𝒉 𝒄𝒐̂𝒏𝒈 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 đ𝒆̂́𝒏 ${NameText}`, threadID)
  } else {
