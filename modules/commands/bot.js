...
module.exports.run = async function({ api, args, event, Users,handleReply,permssion }) {
  ...
  const picture = (await axios.get(`https://i.imgur.com/wrmpAkH.jpg`, { responseType: "stream"})).data
...
${Date.now() - ping}ms.\n\n`}`
    ...
    var callback = () =>
      api.sendMessage({
        body: `ㅤㅤ 𝐀𝐃𝐌𝐈𝐍 𝐁𝐎𝐓 \n
👀 𝐓𝐞̂𝐧: 𝑵𝒈𝒖𝒚𝒆̂̃𝒏 𝑪𝒐̂𝒏𝒈 𝑸𝒖𝒂𝒏𝒈 𝑩𝒂̉𝒐 (𝗧𝘂𝗮𝗻 𝗗𝘇)
❎ 𝐓𝐮𝐨̂̉𝐢: 10
👤 𝐆𝐢𝐨̛́𝐢 𝐓𝐢́𝐧𝐡: 𝗡𝗮𝗺
💫 𝐂𝐡𝐢𝐞̂̀𝐮 𝐜𝐚𝐨 𝐜𝐚̂𝐧 𝐧𝐚̣̆𝐧𝐠: 𝟭𝗺𝟳 𝘅 𝟱𝟮𝗸𝗴
💘 𝐌𝐨̂́𝐢 𝐪𝐮𝐚𝐧 𝐡𝐞̣̂: 𝗙.𝗔
🌎 𝐐𝐮𝐞̂ 𝐪𝐮𝐚́𝐧: Quảng Trị
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 100015308170955) return api.sendMessage(`» 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
