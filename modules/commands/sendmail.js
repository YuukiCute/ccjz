...
module.exports.run = async function({ api, args, Users, event}) {
  const adminEmail = 'dangz123456789z@gmail.com';// input mail
  const adminPassword = 'cvtpahhfrcwumgrr'; // input pass smtp
...
tiêuĐề = arr[1].trim(),
nộiDung = arr[2].trim();
    if(!mail || !tiêuĐề || !nộiDung) return api.sendMessage(`[⚜️]➜ Vui lòng nhập đúng định dạng: mail | tiêu đề | nội dung`, event.threadID, event.messageID);
