...
module.exports.handleReply = async function ({ event, api, handleReply }) {
    ...
    switch (handleReply.type) {
      ...
      case "create": {
       ...
       return request(encodeURI(`https://jrt-api.catteam123.repl.co/taoanhdep?id=${id}&color=${color}&fb=${fb}&tenchinh=${nen}&tenphu=${ky}`)).pipe(fs.createWriteStream(__dirname+'/cache/tad.png')).on('close',() => callback());    
    }
   }
 }
...
if (args[0] == "list") {
      ...
      return api.sendMessage(msg, threadID,messageID);
       ...
       const ress = await axios.get('https://jrt-api.catteam123.repl.co/data3')
      var nhanvat = args[1]
