...
if ((this.config.credits) != "Shiron") { return api.sendMessage(`[ WARNING ] - Phát hiện credits modules ${this.config.name} đã bị thay đổi thành ${this.config.credits} bởi ADMINBOT ${global.config.BOTNAME} 😐 Dừng lại ngay!!!`, event.threadID, event.messageID)}
  ...
  else return api.sendMessage(`🔍 𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝘁𝗲̂𝗻 𝗰𝗵𝗶́𝗻𝗵 𝗹𝗮̀: ${args.join(" ").toUpperCase()}\n\n(𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗰𝗵𝗼̣𝗻 𝘁𝗲̂𝗻 𝗽𝗵𝘂̣ 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻) 🌸`,event.threadID, (err, info) => {
...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
  ...
  switch (handleReply.type) {
    case "tenphu": {
      ...
      return api.sendMessage(`🔍 𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝘁𝗲̂𝗻 𝗽𝗵𝘂̣ 𝗹𝗮̀: ${event.body.toUpperCase()}\n\n(𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝗻𝗵𝗮̣̂𝗽 𝘃𝗮̀𝗼 𝘀𝗼̂́ 𝗽𝗵𝗼𝗻𝗲 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻) 🌸`,threadID, function (err, info) {
        return global.client.handleReply.push({
          type: "sdt",
          name: `coverfb`,
          author: senderID,
    ...
    case "sdt": {
      api.unsendMessage(handleReply.messageID);
      return api.sendMessage(`🔍 𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝗦𝗗𝗧 𝗹𝗮̀: ${event.body.toUpperCase()}\n\n(𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗻𝗵𝗮̣̂𝗽 𝗲𝗺𝗮𝗶𝗹 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻) 🌸`,threadID, function (err, info) {
        return global.client.handleReply.push({
          type: "email",
          name: `coverfb`,
          author: senderID,
    ...
    case "email": {
      api.unsendMessage(handleReply.messageID);
      return api.sendMessage(`🔍 𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝗲𝗺𝗮𝗶𝗹 𝗹𝗮̀: ${event.body.toUpperCase()}\n\n(𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗻𝗵𝗮̣̂𝗽 𝗻𝗼̛𝗶 𝗼̛̉ 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻) 🌸`,threadID, function (err, info) {
        return global.client.handleReply.push({
          type: "color",
          name: `coverfb`,
          author: senderID,
    ...
    case "color": {
      api.unsendMessage(handleReply.messageID);
      return api.sendMessage(`🔍 𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝗻𝗼̛𝗶 𝗼̛̉ 𝗹𝗮̀: ${event.body.toUpperCase()}\n𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗻𝗵𝗮̣̂𝗽 𝗺𝗮̀𝘂 𝗻𝗲̂̀𝗻 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 (𝗻𝗵𝗮̣̂𝗽 𝗻𝗼 𝗹𝗮̀ 𝗺𝗮̀𝘂 𝘁𝗿𝘂𝘆𝗲̂̀𝗻 𝘁𝗵𝗼̂́𝗻𝗴) 🌸`,threadID, function (err, info) {
        return global.client.handleReply.push({
          type: "create",
          name: `coverfb`,
          author: senderID,
